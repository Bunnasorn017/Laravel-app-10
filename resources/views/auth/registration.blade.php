...
<body class="h-full">
    <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8" x-data="{ name: '', email: '', password: '' }">
                ...
                <form class="space-y-6" action="{{ route('register-user') }}" method="post"
                    ...
                    <div>
                        <button type="submit"
                            ...
                            x-bind:disabled="!name || !email || !password"
                            x-bind:class="{ 'opacity-50 cursor-not-allowed': !name || !email || !password }">Register</button>
                    </div>
                </form>
